...
<div class="dashboard-content">
    <div class="welcome-section">
        <h1>{{ trans('dashboard.Welcome to Dashboard') }}</h1>
        <p>{{ trans('dashboard.Overview of General Performance') }}</p>
    </div>
    ...
    <div class="summary-cards">
        <div class="card">
            ...
            <div class="card-content">
                <h3>{{ trans('dashboard.Today Orders') }}</h3>
        ...
        <div class="card">
            ...
            <div class="card-content">
                <h3>{{ trans('dashboard.Total Revenue') }}</h3>
                <div class="number">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <h3>{{ trans('dashboard.Total Users') }}</h3>
        ...
        <div class="card">
            ...
            <div class="card-content">
                <h3>{{ trans('dashboard.Pending Orders') }}</h3>
    ...
    <div class="bottom-section">
        <div class="stats-card">
            <div class="card-header">
                ...
                <h3>{{ trans('dashboard.Revenue Statistics') }}</h3>
            </div>
            <p class="card-subtitle">{{ trans('dashboard.Monthly revenue overview') }}</p>
            <div class="stats-list">
                <div class="stat-item">
                    <span class="stat-label">{{ trans('dashboard.This Month') }}</span>
                ...
                <div class="stat-item">
                    <span class="stat-label">{{ trans('dashboard.Last Month') }}</span>
                    <span class="stat-value">
                        <span class="riyal-symbol">﷼</span>
                ...
                <div class="stat-item">
                    <span class="stat-label">{{ trans('dashboard.Growth') }}</span>
        ...
        <div class="orders-card">
            <div class="card-header">
                ...
                <h3>{{ trans('dashboard.Recent Orders') }}</h3>
            </div>
            <p class="card-subtitle">{{ trans('dashboard.Latest order updates') }}</p>
