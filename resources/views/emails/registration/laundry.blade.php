...
<head>
    ...
    <title>New Laundry Registration</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>New Laundry Registration</h1>
        <p>A new laundry has registered and requires approval</p>
    </div>
    ...
    <div class="content">
        ...
        <div class="info-row">
            ...
            <span class="value">{{ $laundry_address ?? 'Not provided' }}</span>
        </div>
        
        <div class="info-row">
            <span class="label">Laundry Phone:</span>
            <span class="value">{{ $laundry_phone ?? 'Not provided' }}</span>
        </div>
        
        <div class="info-row">
            <span class="label">City ID:</span>
            <span class="value">{{ $city_id ?? 'Not specified' }}</span>
        </div>
